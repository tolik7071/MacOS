...
//    glAttachShader(self.shaderProgram, tescShaderId);
//    glAttachShader(self.shaderProgram, teseShaderId);
//    glAttachShader(self.shaderProgram, geomShaderId);
...
//    const GLubyte *supportedExtensions = glGetString(GL_EXTENSIONS);
//    NSString *extensions = [NSString stringWithFormat:@"%s", supportedExtensions];
//    NSArray *separeted = [extensions componentsSeparatedByString:@" "];
//    for (NSString *feature in separeted)
//    {
//        NSLog(@"%@", feature);
//    }
