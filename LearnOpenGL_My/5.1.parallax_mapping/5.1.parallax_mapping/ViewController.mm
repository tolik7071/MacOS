...
//
//  Created by tolik7071 on 1/11/18.
...
- (void)configOpenGLEnvironment
{
    ...
    NSURL *shader_vs = [self findResourceWithName:@"5.1.parallax_mapping.vs"];
    NSAssert(shader_vs, @"Cannot to find out a shader");
    
    NSURL *shader_fs = [self findResourceWithName:@"5.1.parallax_mapping.fs"];
    ...
    _diffuseMap = [self loadTexture:[[self findResourceWithName:@"textures/bricks2.jpg"] fileSystemRepresentation]];
    
    _normalMap = [self loadTexture:[[self findResourceWithName:@"textures/bricks2_normal.jpg"] fileSystemRepresentation]];
    
    _heightMap = [self loadTexture:[[self findResourceWithName:@"textures/bricks2_disp.jpg"] fileSystemRepresentation]];
...
- (void)renderForTime:(CVTimeStamp)time
{
    ...
    if (_shader != NULL)
    {
        ...
        _shader->setFloat("heightScale", heightScale); // adjust with Q and E keys
