...
//
//  Created by tolik7071 on 3/17/18.
...
- (void)configOpenGLEnvironment
{
    ...
    NSURL *shader_vs = [self findResourceWithName:@"1.2.pbr.vs"];
    NSAssert(shader_vs, @"Cannot to find out a shader");
    
    NSURL *shader_fs = [self findResourceWithName:@"1.2.pbr.fs"];
    ...
    _albedo = [self loadTexture:[[self findResourceWithName:@"textures/pbr/rusted_iron/albedo.png"] fileSystemRepresentation]];
    _normal = [self loadTexture:[[self findResourceWithName:@"textures/pbr/rusted_iron/normal.png"] fileSystemRepresentation]];
    _metallic = [self loadTexture:[[self findResourceWithName:@"textures/pbr/rusted_iron/metallic.png"] fileSystemRepresentation]];
    _roughness = [self loadTexture:[[self findResourceWithName:@"textures/pbr/rusted_iron/roughness.png"] fileSystemRepresentation]];
    _ao = [self loadTexture:[[self findResourceWithName:@"textures/pbr/rusted_iron/ao.png"] fileSystemRepresentation]];
    
    // lights
    
    _lightPositions = new glm::vec3[1]
    {
        glm::vec3(0.0f, 0.0f, 10.0f)
    };
    
    _lightColors = new glm::vec3[1]
    {
...
- (GLuint)loadTexture:(char const * )path
{
    ...
    int width = -1, height = -1, nrComponents = 0;
