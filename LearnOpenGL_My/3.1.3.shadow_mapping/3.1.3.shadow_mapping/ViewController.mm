...
//
//  Created by tolik7071 on 12/21/17.
...
- (void)configOpenGLEnvironment
{
    ...
    {
        NSURL *shader_vs = [self findResourceWithName:@"3.1.3.shadow_mapping.vs"];
        NSAssert(shader_vs, @"Cannot to find out a shader");
        
        NSURL *shader_fs = [self findResourceWithName:@"3.1.3.shadow_mapping.fs"];
    ...
    {
        NSURL *shader_vs = [self findResourceWithName:@"3.1.3.shadow_mapping_depth.vs"];
        NSAssert(shader_vs, @"Cannot to find out a shader");
        
        NSURL *shader_fs = [self findResourceWithName:@"3.1.3.shadow_mapping_depth.fs"];
        NSAssert(shader_fs, @"Cannot to find out a shader");
    ...
    {
        NSURL *shader_vs = [self findResourceWithName:@"3.1.3.debug_quad.vs"];
        NSAssert(shader_vs, @"Cannot to find out a shader");
        
        NSURL *shader_fs = [self findResourceWithName:@"3.1.3.debug_quad_depth.fs"];
        NSAssert(shader_fs, @"Cannot to find out a shader");
    ...
    _woodTexture = [self loadTexture:[[self findResourceWithName:@"textures/wood.png"] fileSystemRepresentation]];
