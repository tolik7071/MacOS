...
- (void)createProgrammUsingVertexShaders:(NSArray<NSURL *> *)vertexShaders
    fragmentShaders:(NSArray<NSURL *> *)fragmentShaders
{
    for (NSURL* vertexShader in vertexShaders)
    {
...
- (void)loadShaders
{
    NSArray<NSURL *> *allVertexShaders = [[NSBundle mainBundle]
        URLsForResourcesWithExtension:@"vsh" subdirectory:nil];
    NSArray<NSURL *> *allFragmentShaders = [[NSBundle mainBundle]
        URLsForResourcesWithExtension:@"fsh" subdirectory:nil];
